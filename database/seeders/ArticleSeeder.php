    ...
    public function run(): void
    {
        ...
        DB::table('articles')->insert([
            [
                ...
                'published_at'=> Carbon::parse('2026-05-12 10:30:00'), // <-- Ajouté
                'created_at'  => Carbon::parse('2026-05-12 10:30:00'),
                'updated_at'  => Carbon::parse('2026-05-12 10:30:00'),
            ...
            [
                ...
                'status'      => 'published', // <-- Ajouté
                'published_at'=> Carbon::parse('2026-06-15 14:45:00'), // <-- Ajouté
                'created_at'  => Carbon::parse('2026-06-15 14:45:00'),
                'updated_at'  => Carbon::parse('2026-06-15 14:45:00'),
                'category_id' => $firstCategoryId,
                'user_id'     => $firstUserId,
            ],
            [
                ...
                'status'      => 'published', // <-- Ajouté
                'published_at'=> Carbon::parse('2026-07-01 09:00:00'), // <-- Ajouté
                'created_at'  => Carbon::parse('2026-07-01 09:00:00'),
                'updated_at'  => Carbon::parse('2026-07-01 09:00:00'),
                'category_id' => $firstCategoryId,
                'user_id'     => $firstUserId,
            ],
            [
                ...
                'status'      => 'published', // <-- Ajouté
                'published_at'=> Carbon::parse('2026-07-15 16:30:00'), // <-- Ajouté
                'created_at'  => Carbon::parse('2026-07-15 16:30:00'),
                'updated_at'  => Carbon::parse('2026-07-15 16:30:00'),
                'category_id' => $firstCategoryId,
                'user_id'     => $firstUserId,
            ],
        ]);
